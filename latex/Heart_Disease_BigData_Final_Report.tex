...
\begin{enumerate}
    ...
    \item \textbf{SHAP local interpretability:} The current project scope focuses on Global Explainability through feature importance rankings aggregated across the full test set; implementation of SHAP for per-patient Local Interpretation will be addressed in the next project phase.
\end{enumerate}
